...
$__System.register('c', ['9', 'a', 'b'], function (_export) {
  var _createClass, _classCallCheck, Util, Modal;
...
$__System.register('1', ['3', '4', '5', 'c'], function (_export) {
	'use strict';

	var $, Reveal, store, sections, sectionsLength;
		...
		execute: function () {
			...
			if (sectionsLength) {
				[].forEach.call(sections, function (section) {
					var url = section.getAttribute('data-html');

					System['import'](url + '!text').then(function (html) {
						section.innerHTML = html;
						sectionLoaded();
					}, function (err) {
						section.outerHTML = '<section data-state="alert">ERROR: The attempt to fetch ' + url + ' failed with the HTTP status ' + err.status + '. Check your browser\'s JavaScript console for more details.</p></section>';
						sectionLoaded();
					});
				});
			} else {
